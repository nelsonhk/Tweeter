...
public class MainPresenter extends Presenter {
    ...
    public void postStatus(String post) {
        ...
        try {
            ...
            getStatusService().postStatus(newStatus, createPostStatusObserver());
        } catch (Exception ex) {
            view.displayErrorMessage("Failed to post the status because of exception: " + ex.getMessage());
        }
    }

    public PostStatusObserver createPostStatusObserver() {
        return new PostStatusObserver();
    }

    public static class PostStatusObserver implements StatusService.PostStatusObserver {
