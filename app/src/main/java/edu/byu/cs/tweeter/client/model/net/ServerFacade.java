...
public class ServerFacade {
    ...
    // Set this to the invoke URL of your API. Find it by going to your API in AWS, clicking
    //  on stages in the right-side menu, and clicking on the stage you deployed your API to.
    private static final String SERVER_URL = "https://4l1d6l1u97.execute-api.us-west-2.amazonaws.com/dev";
    ...
    public GetStatusResponse getFeed(GetStatusRequest request,String urlPath) throws IOException,
    ...
    public GetStatusResponse getStory(GetStatusRequest request, String urlPath)
        throws IOException, TweeterRemoteException {
        return clientCommunicator.doPost(urlPath, request, null, GetStatusResponse.class);
    }
